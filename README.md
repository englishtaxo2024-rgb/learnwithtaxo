...
Static-only Hostinger Git deployment can show the fallback `index.html`, but authentication, persistent uploads, CSV import, and Google Sheets sync require the Node backend.
